...
1. **Use relative estimation (Story Points) instead of time** 
...
2. **Use collaborative estimation techniques**
...
4. **Use historical data (Velocity)**
...
5. **Account for uncertainty and risk**
...
6. **Encourage Discussion Before Estimating**
...
![Planning Poker Steps](image.png)
